...
class _TagFormScreenState extends State<TagFormScreen> {
  ...
  Future<void> _submit() async {
    ...
    bool success;
    if (_isEdit) {
      success = await controller.updateTag(widget.existingTag!.id, _nameController.text);
    } else {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: _black, letterSpacing: -0.3),
        ),
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: const Icon(Icons.label_rounded, size: 28, color: _orange),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  filled: true, fillColor: _zinc50,
                  contentPadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 14),
                  prefixIcon: const Padding(
                    padding: EdgeInsets.only(left: 12, right: 8),
                    child: Icon(Icons.label_outline_rounded, size: 18, color: _orange),
                  ),
                  prefixIconConstraints: const BoxConstraints(minWidth: 40),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: _zinc200)),
                ...
                validator: (v) {
                  if (v == null || v.trim().isEmpty) return 'Tag name is required';
                  if (v.trim().length < 2) return 'At least 2 characters';
                  return null;
                },
              ).animate().fadeIn(delay: 100.ms, duration: 350.ms).slideY(begin: 0.1, end: 0),
              const SizedBox(height: 8),
              const Text('Use tags to organize and filter your workflows',
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Text(error, style: const TextStyle(color: Color(0xFFDC2626), fontSize: 12.5))),
                    ]),
                  ),
                );
              }),
                  ...
                  child: ElevatedButton(
                    ...
                    child: isLoading
                        ...
                        : Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Icon(_isEdit ? Icons.check_rounded : Icons.add_rounded, size: 18),
                            const SizedBox(width: 8),
                            Text(_isEdit ? 'Save Changes' : 'Create Tag',
  ...
  Widget _label(String text) => Text(text,
      style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: _zinc700, letterSpacing: 0.2));
}
